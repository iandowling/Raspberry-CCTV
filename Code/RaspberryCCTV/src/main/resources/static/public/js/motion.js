    ...
    window.hotSpots = [];
        ...
        var canvasCombined = $("#canvas-combined")[0];
...
function startMotion() {
    ...
    function start() {
        ...
        $(canvasCombined).delay(600).fadeIn();
        $('#canvas-target').delay(600).fadeIn();
    ...
    function blend() {
        ...
        contextCombined.putImageData(blendedData, 0, 0);
    ...
    function checkAreas() {
        ...
        for (var h = 0; h < hotSpots.length; h++) {
            var blendedData = contextCombined.getImageData(hotSpots[h].x, hotSpots[h].y, hotSpots[h].width, hotSpots[h].height);
            var i = 0;
            var average = 0;
    ...
    function getCoords() {
        $('#hotSpots').children().each(function (i, el) {
            var ratio = $("#canvas-target").width() / $('video').width();
            hotSpots[i] = {
